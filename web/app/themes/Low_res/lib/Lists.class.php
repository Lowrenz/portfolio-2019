...
class Lists {
  function __construct(){
        add_action( 'init', array($this,'Lists_post_type'), 0 );
  }
  // Register Custom Post Type
  function Lists_post_type() {
      ...
      $labels = array(
          ...
          'parent_item_colon'     => __( 'Parent Lists:', 'text_domain' ),
          'all_items'             => __( 'All Lists', 'text_domain' ),
          'add_new_item'          => __( 'Add New List', 'text_domain' ),
          'add_new'               => __( 'New List', 'text_domain' ),
          'new_item'              => __( 'New Item', 'text_domain' ),
          'edit_item'             => __( 'Edit List', 'text_domain' ),
          'update_item'           => __( 'Update List', 'text_domain' ),
          'view_item'             => __( 'View Lists', 'text_domain' ),
          'view_items'            => __( 'View Items', 'text_domain' ),
          'search_items'          => __( 'Search Lists', 'text_domain' ),
          'not_found'             => __( 'No Lists found', 'text_domain' ),
          'not_found_in_trash'    => __( 'No Lists found in Trash', 'text_domain' ),
      ...
      $args = array(
          'label'                 => __( 'Lists', 'text_domain' ),
          'description'           => __( 'Lists information pages.', 'text_domain' ),
          'labels'                => $labels,
