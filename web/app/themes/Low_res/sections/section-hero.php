...
<section id="home" class="section section--hero fullpage">
  <div class="hero-background" style="background-image: url('<?php echo $thumb['0']; ?>')"></div>
  <div class="row">
    <div class="small-12 large-6 columns">
      <img class="site-logo align-self-center" src="<?php echo get_template_directory_uri(); ?>/dist/img/lowres-logo.svg"
